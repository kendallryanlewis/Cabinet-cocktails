...
let LINEAR_TOP = Color(hex: "#353935")
let LINEAR_BOTTOM = Color(hex: "#28282B")
let LIGHT_LINEAR_TOP = Color(hex: "#f6efe7")
let LIGHT_LINEAR_BOTTOM = Color(hex: "#e9dcce")
...
let COMBINATION_ERROR = "No Combinations can be found with your current items."
